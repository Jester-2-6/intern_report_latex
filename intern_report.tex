...
\input{0_preface_ack.tex}

\newpage
\section{Introduction to the Training Establishment}
\input{1_intro_wave.tex}

\newpage
\section{Training Experience}
\input{2_1_how_i_got.tex}
\input{2_2_trailnet.tex}
\input{2_3_wallie.tex}
\input{2_4_pipeline.tex}
\input{2_5_hillnet.tex}
\input{2_6_life.tex}
